...
def parse_args():
    ...
    parser.add_argument('--test_fre', type=int, default=20, help='frequency of data visualization')

    # LancBiO parameters
    parser.add_argument('--m', type=int, default=1)
    parser.add_argument('--dim_inc', type=float, default=1.3)
    parser.add_argument('--dim_max', type=int, default=300)
...
if __name__ == '__main__':
    ...
    parameters_dict = {
        ...
        'alg': {
            'values': ['LancBiO','SubBiO','AmIGO-GD','AmIGO-CG','SOBA','TTSA','stocBiO','STABLE']
            }
        }
    sweep_config['parameters'] = parameters_dict
    pprint(sweep_config)

    sweep_id = wandb.sweep(sweep_config, project="LancBiO_Experiments")
