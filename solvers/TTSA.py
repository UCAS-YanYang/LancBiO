...
def ttsa(params, hparams_yy, hparams_xy, val_data_list, args, out_f, reg_f):
    ...
    v_Q = shia(G_gradient,v_0, params,args.eta,args.hessian_q)
...
def shia(G,v,params,eta,max_iter):
    '''
    Args:  
        G: flatten vector, used to inner product with v, e.g. G=Gy
    '''
    ...
    for _ in range(max_iter):
        ...
        z_list.append(v_0)            
    v_Q = eta*(v_temp+torch.sum(torch.stack(z_list), dim=0))
