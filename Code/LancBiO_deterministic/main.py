...
def parse_args():
    ...
    parser.add_argument('--test_fre', type=int, default=50, help='frequency of data visualization')
...
if __name__ == '__main__':
    ...
    parameters_dict = {
        ...
        'alg': {
            'values': ['LancBiO','AmIGO-CG','SOBA','stocBiO','AmIGO-GD','BSA','SubBiO','TTSA',]#,'SubBiO','AmIGO-CG','SOBA','TTSA','stocBiO','SOBA','LancBiO','AmIGO-CG','SubBiO'
            }
        }
