...
if __name__ == '__main__':
    ...
    parameters_dict = {
        ...
        'alg': {
            'values': ['HJFBiO']#,'SubBiO','AmIGO-CG','SOBA','TTSA','stocBiO','STABLE''SOBA','LancBiO','AmIGO-GD','SubBiO','AmIGO-CG','SOBA','TTSA','stocBiO','AmIGO-GD','SubBiO','F2SA'
            }
        }
    sweep_config['parameters'] = parameters_dict
    pprint(sweep_config)

    sweep_id = wandb.sweep(sweep_config, project="LancBiO_DataClean_KMNIST")
