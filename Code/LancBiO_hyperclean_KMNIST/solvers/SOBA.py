...
def soba_solver(args, train_loader, test_loader, val_loader):
    ...
    for epoch in range(args.epochs):
        ...
        v, outer_update, inner_update, res = sobabio(v,parameters, hparams_yy,  hparams_xy, val_data_list, args, out_f, reg_f,epoch)
...
def sobabio(v,params, hparams_yy, hparams_xy, val_data_list, args, out_f, reg_f, epoch):
    '''
