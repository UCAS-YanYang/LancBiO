...
if __name__ == '__main__':
    ...
    parameters_dict = {
        ...
        'alg': {
            'values': ['HJFBiO']#,'SubBiO','AmIGO-CG','SOBA','TTSA','stocBiO','STABLE''SOBA','LancBiO','AmIGO-CG','SubBiO','F2SA'
            }
        }
    sweep_config['parameters'] = parameters_dict
    pprint(sweep_config)

    sweep_id = wandb.sweep(sweep_config, project="LancBiO_Rebuttal_Experiments_DataClean") #"LancBiO_Rebuttal_Experiments_DataClean"
